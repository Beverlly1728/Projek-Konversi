    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tbHitung2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (posConversi2==0){
                    hasilConversi2 = (float) (Integer.parseInt(edInputMasa.getText().toString())* 10);
                    txtHasilMasa.setText(""+hasilConversi2);
                } else if (posConversi2==1){
                    hasilConversi2 = (float) (Integer.parseInt(edInputMasa.getText().toString())* 10 *10);
                    txtHasilMasa.setText(""+hasilConversi2);
                } else if (posConversi2==2){
                    hasilConversi2 = (float) (Integer.parseInt(edInputMasa.getText().toString())/ 10);
                    txtHasilMasa.setText(""+hasilConversi2);
                } else if (posConversi2==3){
                    hasilConversi2 = (float) (Integer.parseInt(edInputMasa.getText().toString())/ 10 / 10);
                    txtHasilMasa.setText(""+hasilConversi2);
                }
